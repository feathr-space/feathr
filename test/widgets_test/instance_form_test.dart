...
void main() {
  testWidgets('Instance Form handles invalid data', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: Column(children: [InstanceForm(onSuccessfulSubmit: (_) => {})]),
        ),
      ),
    );
  ...
  testWidgets('Instance Form handles valid data', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: Column(children: [InstanceForm(onSuccessfulSubmit: (_) => {})]),
